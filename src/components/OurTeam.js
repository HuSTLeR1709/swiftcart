  ...
  export default function OurTeam() {
    return (
      <div className="bg-white py-18 sm:py-32">
        <div className="holder mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-6 xl:grid-cols-3">
          <div className="texthold max-w-2xl">
            <h2 className="teamhead text-3xl font-bold tracking-tight text-orange-600 sm:text-4xl">Meet our leadership</h2>
          ...
          <ul role="list" className="teamlist grid gap-x-8 gap-y-12 sm:grid-cols-2 sm:gap-y-8 xl:col-span-2">
            {people.map((person) => (
              <li key={person.name}>
