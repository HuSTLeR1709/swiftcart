...
const Details = (props) => {
  ...
  return (
    <>
        <div className='detailscontainer w-full h-screen flex p-4 gap-1 justify-center items-center'>
        <div className='detailsmain w-11/12 flex p-4 gap-1 justify-center items-center'>
            <div className='lefttside w-2/5 h-auto flex flex-col gap-4'>
            <div className='detailimg w-full h-3/5 overflow-hidden shadow-lg shadow-blue-400 items-center flex justify-center'><img src={product.image} alt='productimg'></img>

        </div>
        <div className='smallimg w-full h-1/5 flex gap-1 '>
        ...
        <div><h1 className='detailsname text-3xl'>{product.name}</h1></div>
        <div>
        <p className='price text-3xl font-medium text-red-500 line-through mb-4'>{product.old_price}</p> <span className='pricenew font-medium text-3xl text-blue-600'>{product.new_price}</span>
        </div>
        <div>
        ...
        <div className='sizes flex gap-3'>
            ...
            <div className='chart text-blue-500 ml-10 mt-3 underline cursor-pointer'>Size Chart</div>
        </div>
        <div>
            <button className='addtocartbutton px-16 py-2 text-xl font-semibold  bg-yellow-400 hover:bg-blue-300' onClick={()=>{handleAddToCart(product.id)}}>-Add to Cart-</button>
        </div>
        <div>
