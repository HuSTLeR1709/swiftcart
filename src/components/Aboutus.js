...
const Aboutus = () => {
  return (
    <>
        ...
        <div className='text-2xl w-3/4 h-auto mt-20 flex flex-col gap-8  '>
...
<span className='text-2xl font-semibold flex my-8 text-orange-600'>Thank you for choosing SwiftCart. Your journey to swift, stylish, and satisfying shopping starts here!</span></p>
        </div>
            </div>
    </>
  )
