...
const Login = () => {
  return (
    <>
        ...
        <div className='w-full flex flex-col items-center mt-14 gap-6'>
            <p className='text-xl'> Username :</p>
        <input type='text' className='border-2 w-4/5 shadow-lg'></input>
        <p className='text-xl'> Password :</p>
        <input type='text' className='border-2 w-4/5 shadow-lg'></input>
        <button className=' w-4/5 mt-4  bg-red-300 hover:bg-blue-300 p-1 text-xl rounded-xl shadow-lg shadow-blue-300'> -Log In- </button>
        </div>
